      ...
      <div className="w-full max-w-[840px] bg-[#0d1310] border border-[#1b2520] rounded-2xl overflow-hidden shadow-2xl grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative bg-gradient-to-b from-[#111a15] to-[#0a100d] p-10 flex flex-col items-center justify-between border-b md:border-b-0 md:border-r border-[#1b2520]">
          ...
          <div className="flex flex-col items-center max-w-[280px] z-10 text-center my-auto">
            ...
            <p className="text-[11px] text-gray-400 leading-relaxed">
              Harnessing advanced neural grids to optimize global carbon sequestration in real-time.
            </p>
          </div>

          {/* Footer Subtext Inside Graphics Side */}
          <div className="flex items-center gap-1.5 text-[9px] text-gray-500 tracking-widest uppercase z-10 mt-6 md:mt-0">
        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs font-bold text-gray-300 tracking-tight">GreenQuest</span>
          </div>
          ...
          <form onSubmit={handleSignIn} className="w-full flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="#forgot" className="text-[9px] text-[#2ecc71] hover:underline font-bold tracking-wide">
                  Forgot Password?
                </a>
              </div>
              <div className="relative flex items-center">
            ...
            >
              ...
              {!loading && <ArrowRight className="w-3.5 h-3.5 text-black stroke-[2.5]" />}
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <svg className="w-3.5 h-3.5 text-current" viewBox="0 0 24 24">
                <path fill="#EA4335" d="M12.24 10.285V14.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.866-3.577-7.866-8s3.536-8 7.866-8c2.46 0 4.105 1.025 5.047 1.926l3.227-3.11C18.422 1.921 15.564 1 12.24 1 6.033 1 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 10.793-4.537 10.793-10.985 0-.74-.078-1.32-.177-1.71h-10.616z"/>
              </svg>
              <span>Google</span>
            </button>
