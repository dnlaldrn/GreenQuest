  ...
  return (
    <div className="min-h-screen bg-[#0a0f0d] text-white flex flex-col justify-between font-mono p-6 selection:bg-[#22c55e]/30">
      ...
      <main className="flex-1 flex items-center justify-center py-12">
        <div className="w-full max-w-[760px] bg-[#121815] border border-[#1f2924] rounded-2xl p-8 shadow-2xl flex flex-col items-center">
          ...
          {message && (
            <div className="w-full bg-[#2ecc71]/10 border border-[#2ecc71]/40 text-[#2ecc71] p-3 rounded-xl text-xs mb-4 text-center">
          ...
          <form onSubmit={handleSignUp} className="w-full flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Right Column: User Type + Interests */}
              <div className="flex flex-col gap-5">
                {/* Student / Faculty Dropdown */}
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold tracking-wider text-gray-400 uppercase">
                    I am a
                  </label>
                  <div className="relative flex items-center">
                    {userType === "faculty" ? (
                      ...
                      <GraduationCap className="absolute left-4 w-4 h-4 text-gray-500 pointer-events-none" />
                    )}
                    <select
                      value={userType}
